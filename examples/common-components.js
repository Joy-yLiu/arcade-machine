...
const Movement_Controls = defs.Movement_Controls =
  class Movement_Controls extends Component {
      ...
      render_controls () {
          ...
          this.key_triggered_button ("Up", ["n"], () => this.thrust[ 1 ] = -1, undefined, () => this.thrust[ 1 ] = 0);
          this.key_triggered_button ("Forward", ["i"], () => this.thrust[ 2 ] = 1, undefined,
                                     () => this.thrust[ 2 ] = 0);
          this.new_line ();
          ...
          this.key_triggered_button ("Right", ["l"], () => this.thrust[ 0 ] = -1, undefined,
                                     () => this.thrust[ 0 ] = 0);
          this.new_line ();
          this.key_triggered_button ("Down", ["m"], () => this.thrust[ 1 ] = 1, undefined, () => this.thrust[ 1 ] = 0);
